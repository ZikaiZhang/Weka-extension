...
public class HoeffdingTreeTestSepArff {
	...
	public static void main(String[] argv) throws Exception
	{
		...
		HoeffdingTree HoeffdingTreeTest = new HoeffdingTree();
		HoeffdingTreeTest.buildClassifier(dataTrain);;
		
		//evaluate
		eval.evaluateModel(HoeffdingTreeTest, dataTest);
